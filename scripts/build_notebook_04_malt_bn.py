"""Génère notebooks/04_malt_to_bayesian_network.ipynb."""
...
NB_PATH = REPO / "notebooks" / "04_malt_to_bayesian_network.ipynb"
...
"""
        ...
        md("## 3 — Chargement des exports MALT et EDA rapide"),
        py(
            r"""

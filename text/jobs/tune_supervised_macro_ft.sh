#!/bin/bash
# Grille supervised_macro_ft (K-fold CV, balanced accuracy) + fit final du meilleur combo.
#
...
#   SEED=42
#
# Sorties : output/supervised_macro_ft/tuning/grid_summary.csv, best_combo.json
#           puis output/supervised_macro_ft/checkpoints/best_model (si SKIP_FINAL_FIT=0)

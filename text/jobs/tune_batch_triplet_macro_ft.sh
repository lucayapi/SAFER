#!/bin/bash
# Batch Triplet : 8 architectures x 4 paramètres LR, paramètres contrastifs fixes.
# Usage : VARIANTS="last_2_yes full_yes" sbatch jobs/tune_batch_triplet_macro_ft.sh

#SBATCH --job-name=tune_batch_triplet_macro_ft
...
tune_architecture_job_run tune_batch_triplet_macro_ft.py configs/tuning/batch_triplet_macro_ft_grid.yaml

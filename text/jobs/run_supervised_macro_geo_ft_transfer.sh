...
#   CORPUS=metallurgie RUN_BERTOPIC=false bash jobs/run_supervised_macro_geo_ft_transfer.sh
...
echo "[sup-macro-geo-xfer] CORPUS=${CORPUS} RUN_BERTOPIC=${RUN_BERTOPIC:-true} $(date -Iseconds)"
